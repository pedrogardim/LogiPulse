...
namespace LogiPulse.Infrastructure.Migrations
{
    ...
    [Migration("20260424211903_AddFacility")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LogiPulse.Domain.Entities.Dispatches.Dispatch", b =>
                {
                    ...
                    b.HasIndex("FacilityId")
                        .HasDatabaseName("ix_dispatches_facility_id");

                    b.HasIndex("FacilityId1")
                        .HasDatabaseName("ix_dispatches_facility_id1");
            ...
            modelBuilder.Entity("LogiPulse.Domain.Entities.Dispatches.Dispatch", b =>
                {
                    b.HasOne("LogiPulse.Domain.Entities.Facilities.Facility", null)
                        .WithMany("Dispatches")
                        .HasForeignKey("FacilityId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_dispatches_facilities_facility_id");

                    b.HasOne("LogiPulse.Domain.Entities.Facilities.Facility", "Facility")
                        .WithMany()
                        .HasForeignKey("FacilityId1")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_dispatches_facilities_facility_id1");
