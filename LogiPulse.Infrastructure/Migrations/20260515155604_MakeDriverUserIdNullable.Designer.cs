...
namespace LogiPulse.Infrastructure.Migrations
{
    ...
    [Migration("20260515155604_MakeDriverUserIdNullable")]
    partial class MakeDriverUserIdNullable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LogiPulse.Domain.Entities.Dispatches.Dispatch", b =>
                {
                    ...
                    b.HasIndex("DriverId")
                        .HasDatabaseName("ix_dispatches_driver_id");
            ...
            modelBuilder.Entity("LogiPulse.Domain.Entities.Drivers.Driver", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("ExternalId", "TenantId")
                        .IsUnique()
                        .HasDatabaseName("ix_drivers_external_id_tenant_id");

                    b.HasIndex("TenantId", "LicenseNumber")
                        .HasDatabaseName("ix_drivers_tenant_id_license_number");
            ...
            modelBuilder.Entity("LogiPulse.Domain.Entities.Dispatches.Dispatch", b =>
                {
                    ...
                    b.HasOne("LogiPulse.Domain.Entities.Drivers.Driver", "Driver")
                        .WithMany("Dispatches")
                        .HasForeignKey("DriverId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .HasConstraintName("fk_dispatches_drivers_driver_id");
            ...
            modelBuilder.Entity("LogiPulse.Domain.Entities.Drivers.Driver", b =>
                {
                    b.HasOne("LogiPulse.Domain.Entities.Tenants.Tenant", null)
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_drivers_tenants_tenant_id");

                    b.HasOne("LogiPulse.Domain.Entities.Users.User", "User")
                        .WithOne()
                        .HasForeignKey("LogiPulse.Domain.Entities.Drivers.Driver", "UserId")
                        .OnDelete(DeleteBehavior.Restrict)
