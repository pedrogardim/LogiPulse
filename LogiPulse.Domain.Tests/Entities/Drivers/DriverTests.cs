...
public class DriverTests
{
    ...
    {
        var driver = Driver.Create(_tenantId, _userId, ExternalId, Name, LicenseNumber, _licenseExpiryDate, Phone);
    ...
    {
        Action act = () => Driver.Create(Guid.Empty, _userId, ExternalId, Name, LicenseNumber, _licenseExpiryDate, Phone);
    ...
    {
        Action act = () => Driver.Create(_tenantId, Guid.Empty, ExternalId, Name, LicenseNumber, _licenseExpiryDate, Phone);
    ...
    {
        Action act = () => Driver.Create(_tenantId, _userId, externalId!, Name, LicenseNumber, _licenseExpiryDate, Phone);
    ...
    public void Create_ExpiredDriverLicense_ThrowsException()
    {
        ...
        Action act = () => Driver.Create(_tenantId, _userId, ExternalId, Name, LicenseNumber, expiredDate, Phone);
